...
public class MiniQuizApprenantController {
    ...
    public ResponseEntity<?> soumettre(
        ...
        try {
            // Parser les réponses : { "questionId" -> "optionId" }
            ...
            log.info("Mini-quiz soumis : apprenant={} cours={} score={}% reussi={}",
        ...
        if (q.getOptions() != null) {
            List<Map<String, Object>> options = q.getOptions().stream()
                    .map(opt -> {
                        ...
                        // estCorrecte NON exposé avant soumission
                        return om;
                    })
                    .collect(Collectors.toList());
    ...
    /**
     * Parse le payload JSON { "reponses": { "123": "456", ... } }
     * en Map<Long questionId, Long optionId>
     */
